...
QT_MOC_LITERAL(3, 23, 13), // "statusChanged"
QT_MOC_LITERAL(4, 37, 14) // "secondsChanged"

    },
    "MyThread\0valueChanged\0\0statusChanged\0"
    "secondsChanged"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->secondsChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::statusChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (MyThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::secondsChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void MyThread::statusChanged(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void MyThread::secondsChanged(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
